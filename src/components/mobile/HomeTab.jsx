...
export default function HomeTab({ posts = [], projects = [] }) {
  ...
  return (
    <div style={{ flex: 1, overflowY: 'auto', WebkitOverflowScrolling: 'touch' }}>
      ...
      <div
        style={{ padding: '0 16px 16px', display: 'flex', flexDirection: 'column', gap: '14px' }}
      >
        {/* Hero */}
        <div
          style={{
        ...
        >
          ...
          <div
            style={{
              fontSize: 'calc(22px * var(--os-font-mult, 1))',
              fontWeight: 700,
              lineHeight: 1.15,
            }}
          >
        ...
        {featuredProjects.length > 0 && (
          <div>
            ...
            >
              <span style={{ fontSize: 'calc(17px * var(--os-font-mult, 1))', fontWeight: 600 }}>
                Featured Work
              </span>
            </div>
                ...
                >
                  ...
                  >
                    <div style={{ flex: 1 }}>
                      <div
                        style={{
                          fontSize: 'calc(15px * var(--os-font-mult, 1))',
                          fontWeight: 600,
                          color: 'var(--text)',
                        }}
                      >
