  ...
  terminal: {
    active: (
      <svg width="30" height="30" viewBox="0 0 24 24" fill="none">
        ...
        <path d="M6 10L9 13L6 16M11 16H18" stroke="var(--accent)" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>
    ),
    inactive: (
      <svg width="30" height="30" viewBox="0 0 24 24" fill="none">
        <rect x="3" y="5" width="18" height="14" rx="2" stroke="rgba(200,200,210,0.7)" stroke-width="1.5" fill="none"/>
        <path d="M6 10L9 13L6 16M11 16H18" stroke="rgba(200,200,210,0.7)" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>
    ),
  },
};
